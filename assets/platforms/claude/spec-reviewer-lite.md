...
expansion, and reinvention of a suitable local pattern. Report complexity or
reuse only with a concrete smaller implementation or existing alternative.
Ignore style-only preferences and optional improvements. Do not trust the
